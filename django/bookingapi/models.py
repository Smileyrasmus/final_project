...
class BookableLocation(basemodel):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['name', 'created_by'], name='unique_location_name',
...
class Seat(basemodel):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['name', 'bookable_location'], name='unique_seat_name',
...
class LocationBooking(basemodel):
    ...
    def save(self, *args, **kwargs):
        ...
        if self.id is None:
            if LocationBooking.objects.filter(bookable_location=self.bookable_location, start_time__lt=self.end_time,
